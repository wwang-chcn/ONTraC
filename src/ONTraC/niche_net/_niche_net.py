"""This module contains functions for niche network construction in ONTraC, including building KNN network, calculating edge index, calculating niche weight matrix, calculating cell type composition, and saving the results to disk."""
...
def construct_niche_network_sample(sample_name: str,
    ...
    Returns
    -------
    None. 1) get coordinates and save it. 2) save the celltype information. 3) build KDTree. 1. save edge index file. 2. calculate weight matrix. 3. calculate cell type composition and save it."""
