...
def plot_cell_type_composition(ana_data: AnaData) -> Optional[Tuple[plt.Figure, plt.Axes]]:
    """
...
def plot_niche_NT_score(ana_data: AnaData) -> Optional[Tuple[plt.Figure, plt.Axes]]:
    """
...
def plot_cell_NT_score(ana_data: AnaData) -> Optional[Tuple[plt.Figure, plt.Axes]]:
    """
